	...
	<div class="content">
		...
		<article class="post hentry">
			<header class="entry-header">
				<h2 class="article-title">${FullArticle.title }</h2>
			</header>

			<div class="entry-content">
				<p>${FullArticle.description }</p>
			</div>
			...
			<div class="entry-meta">
				<span class="post-date"> <i class="fa fa-clock-o fa-fw"></i>
					<span class="updated"><fmt:formatDate type="date"
							value="${FullArticle.datetime }" /> </span>
				</span>
				<!-- .post-date -->
				<span class="post-author"> <i class="fa fa-user fa-fw"></i>
					Posted by <span class="vcard"><a class="fn url" href="#">${FullArticle.createdBy }</a></span>
				</span>
				<!-- .post-author -->

				<span class="post-tags"> <i class="fa fa-tags fa-fw"></i>${FullArticle.tags }
				</span>
				<!-- .post-tags -->
