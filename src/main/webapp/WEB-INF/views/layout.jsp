...
<link rel="icon" href="<%=request.getContextPath()%>/resources/resume_template/images/favicon.jpg" />
			...
			<div class="row">
				<div class="one-third-block">
					...
					<div class="contact-widget widget">
						...
						<p><i class="fa fa-phone fa-fw"></i>+91 9011822778</p>
						<p><i class="fa fa-envelope fa-fw"></i>info@j4java.com</p>
					</div>
					<!-- .contact-widget -->
				...
				<div class="one-third-block">
					...
					<div class="connect-widget widget">
						...
						<form class="widget-form" action="#" method="get">
							<input type="email" class="form-control" placeholder="Enter your email address" value="" name="email" title="Enter your email address" />
							<button class="btn btn-success" style="background-color: #333; border-color: #333;">Subscribe</button>
						</form>
					</div>
					<!-- .recent-posts-widget -->
